...
class Cancelledlist extends React.Component {
  state = {
    rowData: [],
    ...
    columnDefs: [
      ...
      {
        headerName: "Appointments Number",
        field: "customername",
        filter: true,
        width: 180,
        cellRendererFramework: (params) => {
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/cancelled/viewcancelledlist/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/cancelled/editcancelledlist/${params.data._id}`
                      )
                    }
                  />
                )}
      ...
      (
        <div>
          {/* <Breadcrumbs
            ...
            breadCrumbActive="Cancelled List"
          /> */}
