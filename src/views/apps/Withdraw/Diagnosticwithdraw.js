...
class Diagnosticswithdraw extends React.Component {
  state = {
    rowData: [],
  ...
  render() {
    ...
    return (
      ...
      (
        <div>
          {/* <Breadcrumbs
            breadCrumbTitle="Withdraw  "
            breadCrumbParent="Diagnostic Withdraw"
...
export default Diagnosticswithdraw;
