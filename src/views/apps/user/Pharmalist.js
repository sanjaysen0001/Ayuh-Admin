...
class Pharmalist extends React.Component {
  state = {
    ...
    columnDefs: [
      ...
      //   filter: true,
      //   width: 150,
      //   cellRendererFramework: (id, value, onChange) => {
      //     return (
      //       <div>
      //         <span>
      //         <Switch
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    color="green"
                    onClick={() =>
                      history.push(`/pharma/viewpahrma/${params.data._id}`)
                    }
                  />
                )}
              />
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    color="blue"
                    onClick={() =>
                      history.push(`/pharma/editpharma/${params.data._id}`)
                    }
                  />
                )}
              />
  ...
  async componentDidMount() {
    await axiosConfig.get(`/admin/pharma-list`).then((response) => {
      let rowData = response?.data?.Pharma;
      console.log(rowData);
      ...
      (
        <div>
          {/* <Breadcrumbs
            ...
            breadCrumbParent="Pharma"
            // breadCrumbActive=" Pharma List"
          /> */}
                    ...
                    <Route
                      render={({ history }) => (
                        <Button
                          ...
                          onClick={() => history.push("/user/userlistform/AddPharma")}
                        >
                          Add Pharma
                        </Button>
                      )}
