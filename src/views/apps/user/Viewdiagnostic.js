...
//         const response = await axiosConfig.get(`/diagnostic/diagnostic-by-id/${id}`);
...
//             <Row className="m-2">
//               <Col>
//                 <h1 className="float-left">View Diagnostic</h1>
//               </Col>
//               <Col>
...
//                   <Row className='mt-1'>
//                   <Col sm="4" md="4" lg="4">
//                   <span>Diagnostic Number</span>
//                   </Col>
//                   <Col sm="4" md="4" lg="4">
//                   <span>8520004596</span>
//                   </Col>
//                   </Row>
//                   <Row className='mt-1'>
//                   <Col sm="4" md="4" lg="4">
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const { id } = props.match.params;
        const response = await axiosConfig.get(`/diagnostic/diagnostic-by-id/${id}`);
        const userData = response.data.Diagnostic;
        setUserData(userData);
      } catch (error) {
        console.log(error.response);
      }
                ...
                <Row className="ml-4">
                  <Col sm="9" md="12" lg="12">
                    {[
                      ...
                      { label: 'Diagnostic Number', value: userData.mobileNumber },
