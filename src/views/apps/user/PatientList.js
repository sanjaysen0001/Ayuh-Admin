...
class UserList extends React.Component {
              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    color="green"
                    onClick={() =>
                      history.push(`/app/user/ViewPatient/${params.data._id}`)
                    }
                  />
                )}
              />
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    color="blue"
                    onClick={() =>
                      history.push(`/app/user/editPatient/${params.data._id}`)
                    }
                  />
                )}
              />
  ...
  async componentDidMount() {
    await axiosConfig.get(`/admin/patient-list`).then((response) => {
      let rowData = response.data?.Patient;
  ...
  async runthisfunction(id) {
    swal(
      ...
      switch (value) {
        case "delete":
          axiosConfig.delete(`/patient/patient-delete/${id}`).then(
            (response) => {
