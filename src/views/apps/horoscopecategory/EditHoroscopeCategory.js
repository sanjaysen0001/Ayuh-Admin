...
export class EditHoroscopeCategory extends Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "",
  ...
  render() {
    return (
      <div>
        <Breadcrumbs
          breadCrumbTitle="Edit Horoscope Category"
...
export default EditHoroscopeCategory;
