...
import {  Edit, Trash2, ChevronDown, Download } from "react-feather";
...
class Diagpharma extends React.Component {
  state = {
    rowData: [],
              ...
              <Route
                render={({ history }) => (
                  <Download
                    ...
                    onClick={() =>
                      history.push(
                        `/invoice/diagnoinvice/${params.data._id}`
                      )
                    }
                  />
                )}
