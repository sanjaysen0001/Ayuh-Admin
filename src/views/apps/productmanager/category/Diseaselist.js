              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/disease/Viewdisease/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/disease/editdisease/${params.data._id}`
                      )
                    }
                  />
                )}
                        ...
                        <Button
                          ...
                          onClick={() =>
                            history.push(
                              ...
                              "/app/productmanager/category/Adddiseaseform"
                            )
                          }
                        >
                          Add
