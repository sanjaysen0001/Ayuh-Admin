...
export class pharmacomissionform extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleSubmit(event) {
    ...
    // Post data to API
    axiosConfig
      .post("/medicine-commision/insert", {
              ...
              <Route
                render={({ history }) => (
                  <Button
                    ...
                    onClick={() => history.push("/app/productmanager/category/commissionmangement/pharmacommission")}
                  >
                    Back
                  </Button>
                )}
...
export default pharmacomissionform;
