...
import AddDiagon from "./views/apps/user/userlistform/AddDiagnostic";
...
const DRWalletTransaction = lazy(() =>
  import("./views/apps/productmanager/Businessmanagment/DrWalletrhistory")
);
const UserWalletTransaction = lazy(() =>
  import("./views/apps/productmanager/Businessmanagment/Userwallethistory")
);
...
const AddsubCategory = lazy(() =>
  import("./views/apps/productmanager/category/Appmanageform/AddsubCategory")
);
const AddDisease = lazy(() =>
  import("./views/apps/productmanager/category/Appmanageform/Adddiseaseform")
);
